        ...
        if(get_option('users_can_register')){
            ...
            <form method="post" action="" id="registerform" name="registerform" class="login-form">
                ...
                if(!$_social_only){ ?>
                    ...
                    echo \WPDM\libs\User::signupForm($params);
                    ?>
                ...
                jQuery(function ($) {
                    ...
                    $('#registerform').submit(function (e) {
                        ...
                        if( $('#reg_password').val() !== $('#reg_confirm_pass').val() ){
                            ...
                            WPDM.beep();
                            $('#__signup_msg').html("<div class='alert  alert-danger'><?php echo __( "Password did not match with the confirm password", "download-manager" ) ?></div>");
                            return false;
                        } else {
                            $('#reg_confirm_pass').parent('.input-wrapper').removeClass('input-error');
                        }
                        WPDM.blockUI('#registerform');
                        $('#registerform-submit').html("<i class='fa fa-spin fa-sun'></i> <?php _e( "Please Wait..." , "download-manager" ); ?>").attr('disabled', 'disabled');
                        $(this).ajaxSubmit({
